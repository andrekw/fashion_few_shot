...
- ~data_augmentation.py~ adds data augmentation to the procedure above and results in a measurable improvement over the baseline;
- ~data_augmentation_no_early_stopping.py~ lets the data augmentation model run for longer.
